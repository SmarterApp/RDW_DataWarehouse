...
ENT_LIST = [STATES, DISTRICTS, SCHOOLS, PARENTS, ASSESSMENT_TYPES, SECTIONS, STUDENTS, WHERETAKEN, TEACHERS, ASSESSMENT_OUTCOME, TEACHER_SECTIONS, EXTERNAL_USER_STUDENT]
