...
DEFAULT_LANDING_ZONE_OUTCOME_FILE = DATAFILE_PATH + '\\data_files\\fact_asmt_outcome_landing_zone'
DEFAULT_FACT_ASMT_OUTCOME_FILE = DATAFILE_PATH + '\\data_files\\fact_asmt_outcome.csv'
