define [
  ...
  createPopover = ->
    ...
    $("#help").popover
      ...
      template: '<div class="popover footerPopover"><div class="arrow"></div><div class="popover-inner large"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>'
      content: ->
        '<p>Send your inquiries to our <a href="mailto:SmarterBalancedReporting@wgen.net?subject=Smarter Balanced Reporting: Help Inquiries">System Administrator</a>, and be sure to include your userid in the body of the email.</p><br>You should receive a response within 2 business days.</p>'
