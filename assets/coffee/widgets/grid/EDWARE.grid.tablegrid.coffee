define [
  ...
  class EdwareGrid
    ...
    iabSortIconHighlight:() ->
      ...
      true_desc_icon_class = $("#gridWrapper.IAB .ui-state-default .ui-jqgrid-htable #jqgh_gridTable_student_full_name .s-ico .ui-icon-desc").attr("class")
      ...
      if true_desc_icon_class?
        $("#gridWrapper.IAB .frozen-div .ui-jqgrid-htable #jqgh_gridTable_student_full_name .s-ico .ui-icon-desc").attr("class", true_desc_icon_class)
