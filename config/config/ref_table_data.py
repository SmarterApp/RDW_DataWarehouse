...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('1', 'lz_csv', 'group_1_id', 'stg_sbac_asmt_outcome', 'group_1_id', 'clean', None),
        ('1', 'lz_csv', 'group_1_text', 'stg_sbac_asmt_outcome', 'group_1_text', 'clean', None),
        ('1', 'lz_csv', 'group_2_id', 'stg_sbac_asmt_outcome', 'group_2_id', 'clean', None),
        ('1', 'lz_csv', 'group_2_text', 'stg_sbac_asmt_outcome', 'group_2_text', 'clean', None),
        ...
        ('3', 'stg_sbac_asmt_outcome', 'group_1_id', 'int_sbac_asmt_outcome', 'group_1_id', None, 'substr({src_column}, 1, {length})'),
        ('3', 'stg_sbac_asmt_outcome', 'group_1_text', 'int_sbac_asmt_outcome', 'group_1_text', None, 'substr({src_column}, 1, {length})'),
        ('3', 'stg_sbac_asmt_outcome', 'group_2_id', 'int_sbac_asmt_outcome', 'group_2_id', None, 'substr({src_column}, 1, {length})'),
        ('3', 'stg_sbac_asmt_outcome', 'group_2_text', 'int_sbac_asmt_outcome', 'group_2_text', None, 'substr({src_column}, 1, {length})'),
