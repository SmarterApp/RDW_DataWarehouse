...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_asl_video_embed', 'INT_SBAC_ASMT_OUTCOME', 'acc_asl_video_embed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_asl_human_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_asl_human_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_braile_embed', 'INT_SBAC_ASMT_OUTCOME', 'acc_braile_embed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_closed_captioning_embed', 'INT_SBAC_ASMT_OUTCOME', 'acc_closed_captioning_embed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_text_to_speech_embed', 'INT_SBAC_ASMT_OUTCOME', 'acc_text_to_speech_embed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_abacus_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_abacus_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_alternate_response_options_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_alternate_response_options_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_calculator_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_calculator_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_multiplication_table_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_multiplication_table_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_print_on_demand_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_print_on_demand_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_read_aloud_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_read_aloud_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_scribe_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_scribe_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_speech_to_text_nonembed', 'INT_SBAC_ASMT_OUTCOME', 'acc_speech_to_text_nonembed', None, None),
        ('3', 'STG_SBAC_ASMT_OUTCOME', 'acc_streamline_mode', 'INT_SBAC_ASMT_OUTCOME', 'acc_streamline_mode', None, None),
