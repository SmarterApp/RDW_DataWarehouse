...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('1', 'LZ_JSON', 'claim_performance_levels.level_1.cut_point', 'INT_SBAC_ASMT', 'claim_score_cut_point_1', 'clean', None),
        ('1', 'LZ_JSON', 'claim_performance_levels.level_2.cut_point', 'INT_SBAC_ASMT', 'claim_score_cut_point_2', 'clean', None),
        ...
        ('4', 'INT_SBAC_ASMT', 'claim_score_cut_point_1', 'dim_asmt', 'claim_score_cut_point_1', None, None),
        ('4', 'INT_SBAC_ASMT', 'claim_score_cut_point_2', 'dim_asmt', 'claim_score_cut_point_2', None, None),
