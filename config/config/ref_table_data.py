...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('4', 'int_sbac_asmt_outcome', 'nextval(\'"GLOBAL_REC_SEQ"\')', 'dim_student_demographics', 'student_demographic_rec_id', None, None),
        ...
        ('4', 'int_sbac_asmt_outcome', 'nextval(\'"GLOBAL_REC_SEQ"\')', 'fact_asmt_outcome', 'asmt_outcome_rec_id', None, None),
        ...
        ('4', 'int_sbac_asmt_outcome', '-1', 'fact_asmt_outcome', 'section_rec_id', None, None),
        ...
        ('4', 'int_sbac_asmt_outcome', 'nextval(\'"GLOBAL_REC_SEQ"\')', 'fact_asmt_outcome_primary', 'asmt_outcome_primary_rec_id', None, None),
