...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_hsp', 'int_sbac_stu_reg', 'dmg_eth_hsp', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_ami', 'int_sbac_stu_reg', 'dmg_eth_ami', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_asn', 'int_sbac_stu_reg', 'dmg_eth_asn', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_blk', 'int_sbac_stu_reg', 'dmg_eth_blk', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_pcf', 'int_sbac_stu_reg', 'dmg_eth_pcf', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_eth_wht', 'int_sbac_stu_reg', 'dmg_eth_wht', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_prg_iep', 'int_sbac_stu_reg', 'dmg_prg_iep', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_prg_lep', 'int_sbac_stu_reg', 'dmg_prg_lep', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_prg_504', 'int_sbac_stu_reg', 'dmg_prg_504', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_sts_ecd', 'int_sbac_stu_reg', 'dmg_sts_ecd', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_sts_mig', 'int_sbac_stu_reg', 'dmg_sts_mig', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ('3', 'stg_sbac_stu_reg', 'dmg_multi_race', 'int_sbac_stu_reg', 'dmg_multi_race', None, 'case {src_column} when \'\' then null else cast({src_column} as bool) end'),
        ...
        ('4', 'int_sbac_stu_reg', 'guid_district', 'student_reg', 'district_id', None, None),
        ('4', 'int_sbac_stu_reg', 'name_district', 'student_reg', 'district_name', None, None),
        ('4', 'int_sbac_stu_reg', 'guid_school', 'student_reg', 'school_id', None, None),
        ('4', 'int_sbac_stu_reg', 'name_school', 'student_reg', 'school_name', None, None),
        ('4', 'int_sbac_stu_reg', 'guid_student', 'student_reg', 'student_id', None, None),
