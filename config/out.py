...
FAO_FORMAT = {'format': 'csv',
              ...
              'columns': [{'name': 'asmnt_outcome_rec_id', 'val': 'UNIQUE_REC_ID'},
...
DIM_STUDENT_FORMAT = {'format': 'csv',
                      ...
                      'columns': [{'name': 'student_rec_id', 'val': 'UNIQUE_REC_ID'},
                                  {'name': 'batch_guid', 'val': 'BATCH_GUID'},
                                  {'name': 'student_guid', 'val': 'student.guid'},
                                  ...
                                  {'name': 'district_guid', 'val': 'district.guid'},
                                  {'name': 'school_guid', 'val': 'school.guid'},
                                  {'name': 'from_date', 'val': '2013-09-01'},
                                  {'name': 'to_date', 'val': '2027-06-01'},
                                  {'name': 'most_recent', 'val': 'student.grade', 'filter': 'always_true'}]}

DIM_INST_HIER_FORMAT = {'format': 'csv',
                        'name': 'dim_inst_hier.csv',
                        'columns': [{'name': 'inst_hier_rec_id', 'val': 'UNIQUE_REC_ID'},
                                    {'name': 'batch_id', 'val': 'BATCH_GUID'},
...
DIM_SECTION_FORMAT = {'format': 'csv',
                      ...
                      'columns': [{'name': 'section_rec_id', 'val': 'UNIQUE_REC_ID'},
                                  {'name': 'batch_id', 'val': 'BATCH_GUID'},
                                  {'name': 'section_guid', 'val': 'section.guid'},
...
DIM_ASMT_FORMAT = {'format': 'csv',
                   'name': 'dim_asmt.csv',
                   'columns': [{'name': 'asmt_rec_id', 'val': 'UNIQUE_REC_ID'},
