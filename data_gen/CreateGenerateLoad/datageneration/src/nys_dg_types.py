...
def get_school_types():
    ...
    """
    school_types = {
        'High School': {'type': 'High School', 'grades': [9, 10, 11, 12], 'students': {'min': 1, 'max': 1, 'avg': 1}},
        'Middle School': {'type': 'Middle School', 'grades': [6, 7, 8], 'students': {'min': 1, 'max': 1, 'avg': 1}},
        'Elementary School': {'type': 'Elementary School', 'grades': [1, 2, 3, 4, 5], 'students': {'min': 1, 'max': 1, 'avg': 1}},
    }
...
def get_state_types():
    ...
    """
    state_types = {'typical_1': {'district_types_and_counts': {'Big Average': 239, 'Medium Average': 300, 'Small Average': 400},
...
def get_performance_level_distributions():
    ...
    pld = {'ELA': {'1': {'percentages': [30, 34, 28, 9]},
                   '2': {'percentages': [30, 34, 28, 9]},
                   '3': {'percentages': [30, 34, 28, 9]},
                   '4': {'percentages': [29, 36, 28, 7]},
                   '5': {'percentages': [27, 38, 29, 6]},
                   '6': {'percentages': [26, 39, 29, 6]},
                   '7': {'percentages': [25, 40, 30, 5]},
                   '8': {'percentages': [23, 42, 31, 4]},
                   '9': {'percentages': [30, 34, 28, 9]},
                   '10': {'percentages': [30, 34, 28, 9]},
                   '11': {'percentages': [21, 44, 32, 3]},
                   '12': {'percentages': [30, 34, 28, 9]}
                   },
           'Math': {'1': {'percentages': [26, 37, 28, 9]},
                    '2': {'percentages': [26, 37, 28, 9]},
                    '3': {'percentages': [14, 42, 37, 7]},
                    '4': {'percentages': [16, 42, 35, 7]},
                    '5': {'percentages': [18, 41, 33, 8]},
                    '6': {'percentages': [20, 40, 31, 9]},
                    '7': {'percentages': [22, 39, 30, 9]},
                    '8': {'percentages': [24, 38, 29, 9]},
                    '9': {'percentages': [26, 37, 28, 9]},
                    '10': {'percentages': [26, 37, 28, 9]},
                    '11': {'percentages': [26, 37, 28, 9]},
                    '12': {'percentages': [26, 37, 28, 9]}}
           }
    return pld
