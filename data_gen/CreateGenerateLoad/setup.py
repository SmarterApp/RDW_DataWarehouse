...
setup(name='CreateGenerateLoad',
      ...
      packages=['edschema', 'edschema.metadata', 'edschema.tests',
                ...
                'DataGeneration', 'DataGeneration.functional_tests', 'DataGeneration.src', 'DataGeneration.tests',
                'datainfo',
                'dataload',
                ],
      ...
      package_data={'Henshin': ['../Henshin/datafiles/*.json'],
                    'DataGeneration': ['../DataGeneration/datafiles/*.csv', '../DataGeneration/datafiles/*/*']},
