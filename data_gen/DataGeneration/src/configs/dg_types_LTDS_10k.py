...
Approximately 10k Fact Assessment Outcome Records
...
def get_state_types():
    ...
    """
    state_types = {'LTDS': {'district_types_and_counts': {'Big Average': 5, 'Medium Average': 5, 'Small Average': 5}, 'subjects_and_percentages': {'Math': .99, 'ELA': .99}, 'demographics': 'typical1'}
                   }
    return state_types
