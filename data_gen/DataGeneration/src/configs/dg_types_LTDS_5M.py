...
Approximately 5M Fact Assessment Outcome Records
...
def get_state_types():
    ...
    """
    state_types = {'LTDS': {'district_types_and_counts': {'Big Average': 150, 'Medium Average': 160, 'Small Average': 100}, 'subjects_and_percentages': {'Math': .99, 'ELA': .99}, 'demographics': 'typical1'}
                   }
    return state_types
