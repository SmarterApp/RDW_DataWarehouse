...
def get_district_types():
    ...
    district_types = {'Big Average': {'school_counts': {'min': BIG_MIN, 'max': BIG_MAX, 'avg': BIG_AVG},  # if SML_MIN = 5 then (80, 160, 120)
                      ...
                      'Big Good': {'school_counts': {'min': BIG_MIN, 'max': BIG_MAX, 'avg': BIG_AVG},
                                   'school_types_and_ratios': {
                                       'High School': NORM_HIGH, 'Middle School': NORM_MIDL, 'Elementary School': NORM_ELEM,
                                       'Good High School': FEAT_HIGH, 'Good Middle School': FEAT_MIDL, 'Good Elementary School': FEAT_ELEM,
                                       'Poor High School': OTHR_HIGH, 'Poor Middle School': OTHR_MIDL, 'Poor Elementary School': OTHR_ELEM}
                                   },
                      'Big Poor': {'school_counts': {'min': BIG_MIN, 'max': BIG_MAX, 'avg': BIG_AVG},
                                   'school_types_and_ratios': {
                                       'High School': NORM_HIGH, 'Middle School': NORM_MIDL, 'Elementary School': NORM_ELEM,
                                       'Poor High School': FEAT_HIGH, 'Poor Middle School': FEAT_MIDL, 'Poor Elementary School': FEAT_ELEM,
                                       'Good High School': OTHR_HIGH, 'Good Middle School': OTHR_MIDL, 'Good Elementary School': OTHR_ELEM}
                                   },
                      ...
                      'Medium Very Good': {'school_counts': {'min': MED_MIN, 'max': MED_MAX, 'avg': MED_AVG},
                                           'school_types_and_ratios': {
                                               'High School': VERY_NORM_HIGH, 'Middle School': VERY_NORM_MIDL, 'Elementary School': VERY_NORM_ELEM,
                                               'Good High School': VERY_FEAT_HIGH, 'Good Middle School': VERY_FEAT_MIDL, 'Good Elementary School': VERY_FEAT_ELEM}
                                           },
                      'Medium Very Poor': {'school_counts': {'min': MED_MIN, 'max': MED_MAX, 'avg': MED_AVG},
                                           'school_types_and_ratios': {
                                               'High School': VERY_NORM_HIGH, 'Middle School': VERY_NORM_MIDL, 'Elementary School': VERY_NORM_ELEM,
                                               'Poor High School': VERY_FEAT_HIGH, 'Poor Middle School': VERY_FEAT_MIDL, 'Poor Elementary School': VERY_FEAT_ELEM}
                                           },
...
def get_demograph_file():
    ...
    return os.path.join(datafile_path, '..', 'datafiles', 'demographicStats3.csv')
