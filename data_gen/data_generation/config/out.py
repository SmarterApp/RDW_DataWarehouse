...
FAO_FORMAT = {'format': 'csv',
              ...
              'columns': [{'name': 'asmt_outcome_rec_id', 'val': 'assessment_outcome.rec_id'},
                          ...
                          {'name': 'asmt_claim_4_perf_lvl', 'val': 'assessment_outcome.claim_4_perf_lvl'},
                          {'name': 'acc_asl_video_embed', 'val': 'assessment_outcome.acc_asl_video_embed'},
                          {'name': 'acc_print_on_demand_items_nonembed', 'val': 'assessment_outcome.acc_print_on_demand_items_nonembed'},
                          {'name': 'acc_noise_buffer_nonembed', 'val': 'assessment_outcome.acc_noise_buffer_nonembed'},
                          {'name': 'acc_braile_embed', 'val': 'assessment_outcome.acc_braile_embed'},
                          {'name': 'acc_closed_captioning_embed',
                                   'val': 'assessment_outcome.acc_closed_captioning_embed'},
                          {'name': 'acc_text_to_speech_embed', 'val': 'assessment_outcome.acc_text_to_speech_embed'},
...
FBAO_FORMAT = {'format': 'csv',
               ...
               'columns': [{'name': 'asmt_outcome_rec_id', 'val': 'assessment_outcome.rec_id'},
                           ...
                           {'name': 'date_taken_month', 'val': 'assessment_outcome.date_taken', 'filter': 'date_m'},
                           {'name': 'date_taken_year', 'val': 'assessment_outcome.date_taken', 'filter': 'date_Y'},
                           # {'name': 'asmt_perf_lvl', 'val': 'assessment_outcome.claim_1_perf_lvl'},
                           {'name': 'asmt_claim_1_score', 'val': 'assessment_outcome.claim_1_score'},
                           {'name': 'asmt_claim_1_score_range_min', 'val': 'assessment_outcome.claim_1_score_range_min'},
                           {'name': 'asmt_claim_1_score_range_max', 'val': 'assessment_outcome.claim_1_score_range_max'},
                           {'name': 'asmt_claim_1_perf_lvl', 'val': 'assessment_outcome.claim_1_perf_lvl'},
...
DIM_STUDENT_FORMAT = {'format': 'csv',
                      ...
                      'columns': [{'name': 'student_rec_id', 'val': 'student.rec_id'},
                                  ...
                                  {'name': 'batch_guid', 'val': 'BATCH_GUID'},
                                  {'name': 'group_1_id', 'val': 'student.group_1_id'},
                                  {'name': 'group_1_text', 'val': 'student.group_1_text'},
                                  {'name': 'group_2_id', 'val': 'student.group_2_id'},
                                  {'name': 'group_2_text', 'val': 'student.group_2_text'},
                                  {'name': 'group_3_id', 'val': 'student.group_3_id'},
                                  {'name': 'group_3_text', 'val': 'student.group_3_text'},
                                  {'name': 'group_4_id', 'val': 'student.group_4_id'},
                                  {'name': 'group_4_text', 'val': 'student.group_4_text'},
                                  {'name': 'group_5_id', 'val': 'student.group_5_id'},
                                  {'name': 'group_5_text', 'val': 'student.group_5_text'},
                                  {'name': 'group_6_id', 'val': 'student.group_6_id'},
                                  {'name': 'group_6_text', 'val': 'student.group_6_text'},
                                  {'name': 'group_7_id', 'val': 'student.group_7_id'},
                                  {'name': 'group_7_text', 'val': 'student.group_7_text'},
                                  {'name': 'group_8_id', 'val': 'student.group_8_id'},
                                  {'name': 'group_8_text', 'val': 'student.group_8_text'},
                                  {'name': 'group_9_id', 'val': 'student.group_9_id'},
                                  {'name': 'group_9_text', 'val': 'student.group_9_text'},
                                  {'name': 'group_10_id', 'val': 'student.group_10_id'},
                                  {'name': 'group_10_text', 'val': 'student.group_10_text'},
                                  ]}
...
LZ_ITEMDATA_FORMAT = {'format': 'csv',
                      ...
                      'columns': [{'name': 'key', 'val': 'assessment_outcome_item_data.key'},
                                  {'name': 'student_id', 'val': 'assessment_outcome_item_data.student_id'},  # 'student.guid_sr'},
...
LZ_REALDATA_FORMAT = {'format': 'csv',
                      ...
                      'columns': [{'name': 'StateAbbreviation', 'val': 'state.code'},
                                  ...
                                  {'name': 'Group3Id', 'val': 'assessment_outcome.group_3_id'},
                                  {'name': 'Group3Text', 'val': 'assessment_outcome.group_3_text'},
                                  {'name': 'Group4Id', 'val': 'assessment_outcome.group_4_id'},
                                  {'name': 'Group4Text', 'val': 'assessment_outcome.group_4_text'},
                                  {'name': 'Group5Id', 'val': 'assessment_outcome.group_5_id'},
                                  {'name': 'Group5Text', 'val': 'assessment_outcome.group_5_text'},
                                  {'name': 'Group6Id', 'val': 'assessment_outcome.group_6_id'},
                                  {'name': 'Group6Text', 'val': 'assessment_outcome.group_6_text'},
                                  {'name': 'Group7Id', 'val': 'assessment_outcome.group_7_id'},
                                  {'name': 'Group7Text', 'val': 'assessment_outcome.group_7_text'},
                                  {'name': 'Group8Id', 'val': 'assessment_outcome.group_8_id'},
                                  {'name': 'Group8Text', 'val': 'assessment_outcome.group_8_text'},
                                  {'name': 'Group9Id', 'val': 'assessment_outcome.group_9_id'},
                                  {'name': 'Group9Text', 'val': 'assessment_outcome.group_9_text'},
                                  {'name': 'Group10Id', 'val': 'assessment_outcome.group_10_id'},
                                  {'name': 'Group10Text', 'val': 'assessment_outcome.group_10_text'},
                                  ...
                                  {'name': 'AccommodationPrintOnDemand',
                                   'val': 'assessment_outcome.acc_print_on_demand_nonembed'},
                                  {'name': 'AccommodationPrintOnDemandItems',
                                   'val': 'assessment_outcome.acc_print_on_demand_items_nonembed'},
