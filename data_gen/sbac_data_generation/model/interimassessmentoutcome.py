...
class SBACInterimAssessmentOutcome(AssessmentOutcome):
    """
    The SBAC-specific interim assessment outcome class.
    """

    # mjacob: using slots here only to avoid bugs due to typos etc.
    __slots__ = ('run_id guid student assessment date_taken '  # inherited from AssessmentOutcome
