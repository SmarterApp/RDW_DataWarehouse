...
@celery.task(name='task.extract.file_estimator')
def estimate_files(root_dir, state_code, asmt_year, asmt_type, asmt_subject, asmt_grade, threshold_size):
    path = _get_path_to_item_csv(root_dir, state_code=state_code, asmt_year=asmt_year, asmt_subject=asmt_subject, asmt_grade=asmt_grade)
