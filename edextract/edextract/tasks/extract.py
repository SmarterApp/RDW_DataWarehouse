...
from edextract.utils.data_archiver import archive_files, encrypted_archive_files, archive_unencrypted_files, GPGPublicKeyException
...
def remote_copy(request_id, src_file_name, copy_info):
    ...
    try:
        ...
        try:
            ...
            raise remote_copy.retry(args=[request_id, src_file_name, copy_info], kwargs={'timeout': timeout}, exc=exc)
    except Exception as e:
        raise ExtractionError(str(e))
