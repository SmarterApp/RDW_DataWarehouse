...
class TestDistrictDataProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.district_data_processor = DistrictDataProcessor(self.category_trackers, self.ed_rg_heirarchy_map)
    ...
    def test_ed_org_map_updates(self):
        ...
        self.assertDictEqual(self.ed_rg_heirarchy_map, {('North Carolina', 'Guilford County', ''): 'GUILFORD_GUID'})
