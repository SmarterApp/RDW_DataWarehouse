...
class TestProgramTrackers(unittest.TestCase):
    ...
    def test_track(self):
        ...
        self.assertEqual(2, len(self.idea_tracker.get_map_entry('school1')))
        self.assertEqual(2, len(self.idea_tracker.get_map_entry('school2')))
        self.assertEqual(1, len(self.lep_tracker.get_map_entry('school1')))
        self.assertEqual(1, len(self.lep_tracker.get_map_entry('school2')))
        self.assertEqual(1, len(self.s504_tracker.get_map_entry('school1')))
        self.assertEqual(1, len(self.s504_tracker.get_map_entry('school2')))
        self.assertEqual(None, self.econ_tracker.get_map_entry('school1'))
        self.assertEqual(None, self.econ_tracker.get_map_entry('school2'))
        self.assertEqual(2, len(self.migr_tracker.get_map_entry('school1')))
        self.assertEqual(None, self.migr_tracker.get_map_entry('school2'))

        self.assertEqual(1, self.idea_tracker.get_map_entry('school1')[2013])
        self.assertEqual(1, self.idea_tracker.get_map_entry('school2')[2013])
        self.assertEqual(1, self.idea_tracker.get_map_entry('school1')[2014])
        self.assertEqual(1, self.idea_tracker.get_map_entry('school2')[2014])
        self.assertEqual(1, self.lep_tracker.get_map_entry('school1')[2013])
        self.assertNotIn(2013, self.lep_tracker.get_map_entry('school2'))
        self.assertNotIn(2014, self.lep_tracker.get_map_entry('school1'))
        self.assertEqual(1, self.lep_tracker.get_map_entry('school2')[2014])
        self.assertEqual(1, self.s504_tracker.get_map_entry('school1')[2013])
        self.assertEqual(1, self.s504_tracker.get_map_entry('school2')[2013])
        ...
        self.assertEqual(1, self.migr_tracker.get_map_entry('school1')[2013])
        self.assertEqual(1, self.migr_tracker.get_map_entry('school1')[2014])
    ...
    def test_track_blanks(self):
        ...
        self.assertEqual(None, self.s504_tracker.get_map_entry('NJ'))
        self.assertEqual(None, self.migr_tracker.get_map_entry('NJ'))
        self.assertEqual(None, self.s504_tracker.get_map_entry('district1'))
        self.assertEqual(None, self.migr_tracker.get_map_entry('district1'))
        self.assertEqual(None, self.s504_tracker.get_map_entry('school1'))
        self.assertEqual(None, self.migr_tracker.get_map_entry('school1'))
