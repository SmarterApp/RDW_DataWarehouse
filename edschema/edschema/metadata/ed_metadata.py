...
def generate_ed_metadata(schema_name=None, bind=None):
    ...
    instit_hier = Table('dim_inst_hier', metadata,
                        ...
                        Column('district_id', String(40), nullable=False, info={'natural_key': True}),
                        Column('district_name', String(60), nullable=False),
                        Column('school_id', String(40), nullable=False, info={'natural_key': True}),
    ...
    students = Table('dim_student', metadata,
                     ...
                     Column('student_id', String(40), nullable=False, info={'natural_key': True}),
                     ...
                     Column('birthdate', String(8), nullable=True),
    ...
    Index('dim_student_id_idx', students.c.student_id, unique=False)
    ...
    assessment = Table('dim_asmt', metadata,
                       ...
                       Column('asmt_perf_lvl_name_1', String(25), nullable=True),
                       Column('asmt_perf_lvl_name_2', String(25), nullable=True),
                       Column('asmt_perf_lvl_name_3', String(25), nullable=True),
                       Column('asmt_perf_lvl_name_4', String(25), nullable=True),
                       Column('asmt_perf_lvl_name_5', String(25), nullable=True),
    ...
    assessment_outcome_vw = Table('fact_asmt_outcome_vw', metadata,
                                  ...
                                  Column('student_id', String(40), nullable=False, info={'natural_key': True}),
                                  Column('state_code', String(2), nullable=False),
                                  Column('district_id', String(40), nullable=False),
                                  Column('school_id', String(40), nullable=False),
    ...
    Index('fact_asmt_block_outcome_student_idx', assessment_block_outcome.c.student_id, assessment_block_outcome.c.asmt_guid, unique=False)
    ...
    student_registration = Table('student_reg', metadata,
                                 ...
                                 Column('school_id', String(40), nullable=False),
                                 Column('school_name', String(60), nullable=False),
                                 Column('student_id', String(40), nullable=False),
    ...
    Index('student_reg_guid_idx', student_registration.c.student_id, unique=False)
