...
class TestInitializeSFTPZone(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sftp_arrivals_sync_path = os.path.join(self.sftp_zone_path, self.test_sftp_conf['dest_dir'])
    ...
    def test__initialize_sftp_zone(self):
        ...
        self.assertTrue(os.path.exists(self.sftp_arrivals_sync_path))
    ...
    def test__cleanup(self):
        ...
        self.assertFalse(os.path.exists(self.sftp_arrivals_sync_path))
