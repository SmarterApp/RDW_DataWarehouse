...
class DataValidationErrorCode(unittest.TestCase):
    ...
    def test_sourcefolder_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FOLDER_NOT_ACCESSIBLE_SFV, "Validation Code for CSV Source folder not accessible is incorrect")
    ...
    def test_sourcefile_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_NOT_ACCESSIBLE_SFV, "Validation Code for CSV Source file not accessible is incorrect")
    ...
    def test_blankfile_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_HAS_NO_DATA, "Validation Code for CSV blank file is incorrect")
    ...
    def test_wrong_delimiter_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_WRONG_DELIMITER, "Validation Code for CSV file with wrong delimiter is incorrect")
    ...
    def test_noHeader_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_HAS_NO_HEADERS, "Validation Code for no header is incorrect")
    ...
    def test_duplicateHeaders_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_HAS_DUPLICATE_HEADERS, "Validation Code for duplicate headers is incorrect")
    ...
    def test_noDataRow_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_HAS_NO_DATA, "Validation Code for atleast one data row is incorrect")
    ...
    def test_dataMismatch_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_FILE_HEADERS_MISMATCH_DATA, "Validation Code for data mismatch row is incorrect")
    ...
    def test_extention_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0][0], error_codes.SRC_FILE_TYPE_NOT_SUPPORTED, "Validation Code for different file formate is incorrect")
    ...
    def test_jsonStructure_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_JSON_INVALID_STRUCTURE, "Validation Code for JSON file structure is incorrect")
    ...
    def test_jsonFormate_errorcode(self):
        ...
        self.assertEqual(expected_error_code[0], error_codes.SRC_JSON_INVALID_FORMAT, "Validation Code for JSON file formate is incorrect")
