...
class FuncTestLoadToIntegrationTable(UDLTestHelper):
    ...
    def test_get_column_mapping_from_stg_to_int(self):
        expected_target_columns = ['name_state', 'code_state', 'guid_district', 'name_district', 'guid_school', 'name_school',
                                   ...
                                   'sex_student', 'birthdate_student', 'grade_enrolled', 'dmg_eth_hsp', 'dmg_eth_ami', 'dmg_eth_asn',
                                   'dmg_eth_blk', 'dmg_eth_pcf', 'dmg_eth_wht', 'dmg_multi_race', 'dmg_prg_iep', 'dmg_prg_lep', 'dmg_prg_504', 'dmg_sts_ecd',
                                   'dmg_sts_mig', 'code_confirm', 'code_language', 'eng_prof_lvl', 'us_school_entry_date', 'lep_entry_date',
                                   'lep_exit_date', 't3_program_type', 'prim_disability_type', 'created_date', 'guid_batch']
        expected_source_columns_with_tran_rule = ['substr("A".name_state, 1, 32)', 'substr("A".code_state, 1, 2)',
                                                  'substr("A".guid_district, 1, 50)', 'substr("A".name_district, 1, 256)', 'substr("A".guid_school, 1, 50)',
                                                  'substr("A".name_school, 1, 256)', 'substr("A".guid_student, 1, 50)',
                                                  'substr("A".external_ssid_student, 1, 50)', 'substr("A".name_student_first, 1, 64)',
                                                  'substr("A".name_student_middle, 1, 64)', 'substr("A".name_student_last, 1, 64)',
                                                  'substr("A".sex_student, 1, 10)', 'substr("A".birthdate_student, 1, 10)', 'substr("A".grade_enrolled, 1, 2)',
                                                  ...
                                                  'substr("A".code_confirm, 1, 50)', 'substr("A".code_language, 1, 3)', 'substr("A".eng_prof_lvl, 1, 20)',
