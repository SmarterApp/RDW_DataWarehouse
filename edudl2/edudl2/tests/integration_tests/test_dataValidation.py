...
class UniuqeCount(unittest.TestCase):
    ...
    def test_unique_dist(self):
        ...
        self.assertEqual(stg_dist_count, dim_dist_count, "No. of districts are not equal in staging table and in dim_inst_hier table(star schema)")
        ...
        self.assertEqual(stg_district_count_result, (fact_district_count_result), "No. of districts are not equal in staging table and in fact_asmt_outcome table(star schema)")
    ...
    def test_unique_school(self):
        ...
        self.assertEqual(stg_school_count_new, dim_school_count_new, "No. of schools are not equal in staging table and in dim_inst_hier table(star schema)")
        ...
        self.assertEqual(stg_school_count_result, fact_school_count_result, "No. of schools are not equal in staging table and in fact_asmt_outcome table(star schema)")
    ...
    def test_unique_state(self):
        ...
        self.assertEqual(stg_state_count_new, dim_state_count_new, "No. of states are not equal in staging table and in dim_inst_hier table(star schema)")
        ...
        self.assertEqual(stg_state_count_result, fact_state_count_result, "No. of states are not equal in staging table and in fact_asmt_outcome table(star schema)")
    ...
    def test_unique_asmt(self):
        ...
        self.assertEqual(stg_asmt_count_result, dim_asmt_count_result, "No. of asmt_guid are not equal in staging table and in dim_asmt table(star schema)")
        ...
        self.assertEqual(stg_asmt_count_result, fact_asmt_count_result, "No. of asmt_guid are not equal in staging table and in fact_asmt_outcome table(star schema)")
    ...
    def test_unique_staff(self):
        ...
        self.assertEqual(stg_staff_count_result, dim_staff_count_result, "No. of staff_guid are not equal in staging table and in dim_staff table(star schema)")
        ...
        self.assertEqual(stg_staff_count_result, fact_staff_count_result, "No. of staff_guid are not equal in staging table and in fact_asmt_outcome table(star schema)")
    ...
    def test_unique_student(self):
        ...
        self.assertEqual(stg_student_count_result, dim_student_count_result, "No. of student_guid are not equal in staging table and in dim_student table(star schema)")
        ...
        self.assertEqual(stg_student_count_result, fact_student_count_result, "No. of students are not equal in staging table and in fact_asmt_outcome table(star schema)")
