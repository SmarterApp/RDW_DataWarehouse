...
class Test(unittest.TestCase):
    ...
    def test_create_filtered_sql_string(self):
        ...
        self.assertRaises(UDL2SQLFilteredSQLStringException, create_filtered_sql_string, (), schema_name=1, table_name="my_table")
        self.assertRaises(UDL2SQLFilteredSQLStringException, create_filtered_sql_string, (), schema_name="my schema", table_name="my_table")
        self.assertRaises(UDL2SQLFilteredSQLStringException, create_filtered_sql_string, (), schema_name="abc", table_name="efg\"; select * from abc;")
