...
python -m edudl2.database.init_database $1 $2 --action teardown
...
python3.3 -m edschema.metadata_generator --metadata edware -a teardown -s edware_pre_prod -d edware --host=localhost:5432 -u edware -p edware2013
