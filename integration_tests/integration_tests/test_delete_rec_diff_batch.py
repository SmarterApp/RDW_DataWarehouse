...
class Test_Error_In_Migration(IntegrationTestCase):
    ...
    def validate_edware_database(self, schema_name):
        with get_target_connection(self.tenant, schema_name) as ed_connector:
            ...
            prod_output_data = select([fact_table_vw.c.rec_status]).where(fact_table_vw.c.student_id == '3efe8485-9c16-4381-ab78-692353104cce', )
            ...
            prod_data = select([fact_table.c.rec_status]).where(fact_table.c.student_id == '3efe8485-9c16-4381-ab78-692353104cce', )
