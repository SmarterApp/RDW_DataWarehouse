...
SUBJECTS_AND_PERCENTS = 'subjects_and_percentages'
...
def get_state_types():
    ...
    """
    state_types = {'Typical1': {'district_types_and_counts': {'Big': 2, 'Medium': 6, 'Small': 40}, 'subjects_and_percentages': {'Math': .9, 'ELA': .9}}
                   }
    return state_types
