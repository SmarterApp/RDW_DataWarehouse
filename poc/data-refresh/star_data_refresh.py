...
RAW_FACT_MIGRATE_SQL = "Insert INTO {schema_name}.{live_Star_fact_table} (batch_guid, asmnt_outcome_rec_id,asmt_rec_id,student_guid,state_code,district_guid,school_guid," \
          ...
          "select \'{fake_batch_guid}\' as batch_guid,{random_start_cnt}+fao.asmnt_outcome_rec_id as asmnt_outcome_rec_id,fao.asmt_rec_id," \
