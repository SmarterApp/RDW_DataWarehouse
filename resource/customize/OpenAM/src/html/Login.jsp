    ...
    <jato:useViewBean className="com.sun.identity.authentication.UI.LoginViewBean">
        ...
        <body onload="placeCursorOnFirstElm();">
            <div class="container_12">
                ...
                <div id="content">
                    <div class="grid_12">
                        <div class="form-horizontal box-content clear-float">
                                    ...
                                    <jato:tiledView name="tiledCallbacks"
                                        ...
                                        <jato:content name="textBox">
                                            <div class="row">
                                                ...
                                                <input class="textbox" type="text" name="IDToken<jato:text name="txtIndex" />" id="IDToken<jato:text name="txtIndex" />" value="<jato:text name="txtValue" />"  placeholder="Email" />
                                            </div>
                                        </jato:content>
                                        <jato:content name="password">
                                            <div class="row">
                                                ...
                                                <input class="textbox" type="password" name="IDToken<jato:text name="txtIndex" />" id="IDToken<jato:text name="txtIndex" />" value=""  placeholder="Password" />
                                            </div>
                                        </jato:content>
