...
@author: V5102883
'''
from myedwareproject.services.querybuilder import getComparePopulationsQuery
from myedwareproject.utils.databaseconnections import getDatabaseConnection
...
def generateComparePopulationsReport(parameters):
    print("Inside generateComparePopulationsReport")
