...
class PDFGenerator(BatchBase):
    ...
    def send_pdf_request(self, student_id, state_code, asmt_period_year, asmt_type, effective_date, file_name, report='indivStudentReport.html'):
        '''
        ...
        pdf_url = self.build_url(student_id, state_code, asmt_period_year, asmt_type, effective_date, report)
    ...
    def build_url(self, student_id, state_code, asmt_period_year, asmt_type, effective_date, report):
        '''
        ...
        encoded_params = urllib.parse.urlencode({'studentId': student_id, 'pdf': 'true', 'stateCode': state_code, 'effectiveDate': effective_date, 'asmtType': asmt_type, 'asmtYear': asmt_period_year})
