...
def get_metadata_file_name(params):
    ...
    '''
    file_name = "METADATA_ASMT_{stateCode}_GRADE_{asmtGrade}_{asmtSubject}_{asmtType}_{asmtGuid}.json".format(stateCode=params.get(Constants.STATECODE).upper(),
...
def get_asmt_metadata(asmt_guid):
    asmt_guid = '8d10d26b-b013-4cdd-a916-5d577e895cce'
    with EdCoreDBConnection() as connector:
        ...
        query = select([literal("assessment").label("content"),
                        ...
                        dim_asmt.c.asmt_claim_1_score_weight.label(mapping.get('asmt_claim_1_score_weight', 'asmt_claim_1_score_weight')),
                        dim_asmt.c.asmt_claim_2_score_weight.label(mapping.get('asmt_claim_2_score_weight', 'asmt_claim_2_score_weight')),
                        dim_asmt.c.asmt_claim_3_score_weight.label(mapping.get('asmt_claim_3_score_weight', 'asmt_claim_3_score_weight')),
                        dim_asmt.c.asmt_claim_4_score_weight.label(mapping.get('asmt_claim_4_score_weight', 'asmt_claim_4_score_weight'))],
                       from_obj=[dim_asmt])
