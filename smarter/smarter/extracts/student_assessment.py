...
def get_extract_assessment_query(params):
    ...
    with EdCoreDBConnection(state_code=state_code) as connector:
        ...
        query = select_with_context([dim_asmt.c.asmt_guid.label(dim_asmt_label.get(Constants.ASMT_GUID, Constants.ASMT_GUID)),
                                    ...
                                    fact_asmt_outcome_vw.c.external_student_id.label(fact_asmt_outcome_vw_label.get('external_student_id', 'external_student_id')),
                                    ...
                                    fact_asmt_outcome_vw.c.dmg_prg_tt1.label(fact_asmt_outcome_vw_label.get('dmg_prg_tt1', 'dmg_prg_tt1')),
                                    ...
                                    fact_asmt_outcome_vw.c.acc_asl_human_nonembed.label(fact_asmt_outcome_vw_label.get('acc_asl_human_nonembed', 'acc_asl_human_nonembed')),
