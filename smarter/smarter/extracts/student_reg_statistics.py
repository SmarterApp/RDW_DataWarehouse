...
def get_match_id_query(academic_year, state_code):
    with EdCoreDBConnection(state_code=state_code) as connection:
        ...
        match_id_query = select_with_context([current_sr.c.state_code, prev_sr.c.state_code.label('prev_state_code'), current_sr.c.state_name, current_sr.c.district_guid,
                                              ...
                                              current_sr.c.dmg_eth_ami, prev_sr.c.dmg_eth_ami.label('dmg_eth_ami'), current_sr.c.dmg_eth_asn, prev_sr.c.dmg_eth_asn.label('prev_dmg_eth_asn'),
                                              current_sr.c.dmg_eth_blk, prev_sr.c.dmg_eth_blk.label('prev_dmg_eth_blk'), current_sr.c.dmg_eth_pcf, prev_sr.c.dmg_eth_pcf.label('dmg_eth_pcf'),
                                              current_sr.c.dmg_eth_wht, prev_sr.c.dmg_eth_wht.label('dmg_eth_wht'), current_sr.c.dmg_prg_iep,
                                              ...
                                              prev_sr.c.dmg_sts_mig.label('prev_dmg_sts_mig'), current_sr.c.dmg_multi_race, prev_sr.c.dmg_multi_race.label('dmg_multi_race'), current_sr.c.academic_year],
