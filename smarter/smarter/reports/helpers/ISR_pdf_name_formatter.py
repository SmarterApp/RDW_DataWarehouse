...
def generate_isr_report_path_by_student_guid(state_code, effective_date=None, asmt_year=None, pdf_report_base_dir='/', student_guids=None, asmt_type=AssessmentType.SUMMATIVE, grayScale=True, lang='en'):
    '''
    ...
    with EdCoreDBConnection(state_code=state_code) as connection:
        ...
        query = query.where(and_(fact_asmt_outcome_vw.c.rec_status == Constants.CURRENT, fact_asmt_outcome_vw.c.student_guid.in_(student_guids)))
