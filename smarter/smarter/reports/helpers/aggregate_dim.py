...
def get_aggregate_dim(subjects={}, stateCode=None, districtGuid=None, schoolGuid=None, asmtType=AssessmentType.SUMMATIVE, asmtYear=None, tenant=None):
    '''
    ...
    for record in records:
        ...
        for key in subjects.keys():
            if results.get(key) is None:
                results[key] = {Constants.ASMT_SUBJECT: subject, Constants.TOTAL: 0, Constants.HASINTERIM: False}
    return {Constants.RECORDS: records}
