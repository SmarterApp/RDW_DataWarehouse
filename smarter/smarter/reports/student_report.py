...
def __prepare_query(connector, state_code, student_guid, assessment_guid):
    ...
    query = select_with_context([fact_asmt_outcome_vw.c.student_guid,
                                ...
                                fact_asmt_outcome_vw.c.acc_asl_human_nonembed.label('acc_asl_human_nonembed'),
                                ...
                                from_obj=[fact_asmt_outcome_vw
                                          ...
                                          .join(dim_asmt, and_(dim_asmt.c.asmt_rec_id == fact_asmt_outcome_vw.c.asmt_rec_id, dim_asmt.c.rec_status == Constants.CURRENT))], permission=RolesConstants.PII, state_code=state_code)
