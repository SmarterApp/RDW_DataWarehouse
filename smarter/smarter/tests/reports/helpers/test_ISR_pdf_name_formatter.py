...
class TestISRPdfNameFormatter(Unittest_with_edcore_sqlite):
    ...
    def test_generate_isr_report_path_by_student_guid(self):
        file_name = generate_isr_report_path_by_student_guid('NC', pdf_report_base_dir='/', student_guid='61ec47de-e8b5-4e78-9beb-677c44dd9b50', effective_date='20160401')
    ...
    def test_generate_isr_report_path_by_student_guid_for_grayScale(self):
        file_name = generate_isr_report_path_by_student_guid('NC', pdf_report_base_dir='/', student_guid='61ec47de-e8b5-4e78-9beb-677c44dd9b50', grayScale=True, lang='jp', effective_date='20160401')
    ...
    def test_generate_isr_report_path_by_student_guid_studentguid_not_existd_for_grayScale(self):
        self.assertRaises(NotFoundException, generate_isr_report_path_by_student_guid, 'NC', pdf_report_base_dir='/', student_guid='ff1c2b1a-c15d-11e2-ae11-3c07546832b4', grayScale=True, effective_date='20120201')
