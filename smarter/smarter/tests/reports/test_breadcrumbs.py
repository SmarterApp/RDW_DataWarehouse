...
class TestContext(Unittest_with_smarter_sqlite):
    ...
    def testDistrictContext(self):
        results = get_breadcrumbs_context(district_id='228')
    ...
    def testSchoolContext(self):
        results = get_breadcrumbs_context(district_id='228', school_id='242')
    ...
    def testGradeContext(self):
        results = get_breadcrumbs_context(district_id='228', school_id='242', asmt_grade='3')
    ...
    def testStudentContext(self):
        results = get_breadcrumbs_context(district_id='228', school_id='242', asmt_grade='3', student_name='StudentName')
