...
class Test(unittest.TestCase):
    ...
    def test_RecordManager_create_interval(self):
        ...
        interval_level1 = manager.create_interval(results[0], 1)
        ...
        interval_level2 = manager.create_interval(results[0], 2)
        ...
        interval_level3 = manager.create_interval(results[0], 3)
        ...
        interval_level4 = manager.create_interval(results[0], 4)
        ...
        interval_level5 = manager.create_interval(results[0], 5)
