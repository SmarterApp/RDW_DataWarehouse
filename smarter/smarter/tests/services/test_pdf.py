...
class TestServices(Unittest_with_edcore_sqlite):
    ...
    def setUp(self):
        ...
        dummy_session = create_test_session(['STUDENT'], uid='a5ddfe12-740d-4487-9179-de70f6ac33be')
        self.__config.testing_securitypolicy(dummy_session)
        # Set up defined roles
        defined_roles = [(Allow, 'STUDENT', ('view', 'logout')),
    ...
    def test_post_pdf_service_no_context(self):
        ...
        dummy_session = create_test_session(['STUDENT'], uid='1020')
        self.__config.testing_securitypolicy(dummy_session)
    ...
    def test_send_pdf_request_with_pdf_generation_fail(self):
        dummy_session = create_test_session(['TEACHER'], uid='1020')
        self.__config.testing_securitypolicy(dummy_session)
        params = {}
