...
def get_json_mapping(root):
    ...
    mappings = [JSONMapping(XMLMeta(root, "./Test", "testId"), json_output, 'asmt_guid'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim1'][@measureLabel='Text']", "value"), json_output, 'claim1_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim2'][@measureLabel='Text']", "value"), json_output, 'claim2_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim3'][@measureLabel='Text']", "value"), json_output, 'claim3_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim4'][@measureLabel='Text']", "value"), json_output, 'claim4_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='PerformanceLevel'][@measureLabel='Level1']", "value"), json_output, 'level1_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='PerformanceLevel'][@measureLabel='Level2']", "value"), json_output, 'level2_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='PerformanceLevel'][@measureLabel='Level3']", "value"), json_output, 'level3_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='PerformanceLevel'][@measureLabel='Level4']", "value"), json_output, 'level4_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='ClaimLevel1'][@measureLabel='Text']", "value"), json_output, 'claim_perf_level1_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='ClaimLevel2'][@measureLabel='Text']", "value"), json_output, 'claim_perf_level2_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='ClaimLevel3'][@measureLabel='Text']", "value"), json_output, 'claim_perf_level3_name'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim1'][@measureLabel='MaxScore']", "value"), json_output, 'claim1_max_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim1'][@measureLabel='MinScore']", "value"), json_output, 'claim1_min_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim2'][@measureLabel='MaxScore']", "value"), json_output, 'claim2_max_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim2'][@measureLabel='MinScore']", "value"), json_output, 'claim2_min_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim3'][@measureLabel='MaxScore']", "value"), json_output, 'claim3_max_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim3'][@measureLabel='MinScore']", "value"), json_output, 'claim3_min_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim4'][@measureLabel='MaxScore']", "value"), json_output, 'claim4_max_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Claim4'][@measureLabel='MinScore']", "value"), json_output, 'claim4_min_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='CutPoint1']", "value"), json_output, 'level1_cutpoint'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='CutPoint2']", "value"), json_output, 'level2_cutpoint'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='CutPoint3']", "value"), json_output, 'level3_cutpoint'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='CutPoint4']", "value"), json_output, 'level4_cutpoint'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='MinScore']", "value"), json_output, 'min_score'),
                JSONMapping(XMLMeta(root, "./Opportunity/Score/[@measureOf='Overall'][@measureLabel='MaxScore']", "value"), json_output, 'max_score'),
                JSONMapping(XMLMeta(root, "./Test", "subject"), json_output, 'subject'),
                JSONMapping(XMLMeta(root, "./Test", "assessmentType"), json_output, 'asmt_type'),
                JSONMapping(XMLMeta(root, "./Test", "assessmentVersion"), json_output, 'asmt_version'),
                JSONMapping(XMLMeta(root, "./Test", "academicYear"), json_output, 'asmt_year'),
                # TODO effective date is unknown
                JSONMapping(XMLMeta(root, "./Test", "effectiveDate"), json_output, 'effective_date')]
    for m in mappings:
        m.evaluate()
