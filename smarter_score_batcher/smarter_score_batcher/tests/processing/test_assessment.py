...
class TestCSVMetadata(unittest.TestCase):
    ...
    def test_get_csv_mapping(self):
        ...
        self.assertEqual(mapping[AssessmentHeaders.AccommodationBraille], '0')
        ...
        self.assertEqual(mapping[AssessmentHeaders.AccommodationAmericanSignLanguage], '0')
    ...
    def test_get_accommodations(self):
        ...
        self.assertEqual(accommodations[0].evaluate(), '0')
        self.assertEqual(accommodations[1].evaluate(), '0')
        self.assertEqual(accommodations[2].evaluate(), '0')
        self.assertEqual(accommodations[3].evaluate(), '0')
        self.assertEqual(accommodations[4].evaluate(), '0')
        self.assertEqual(accommodations[5].evaluate(), '0')
        self.assertEqual(accommodations[6].evaluate(), '0')
        self.assertEqual(accommodations[7].evaluate(), '0')
        self.assertEqual(accommodations[8].evaluate(), '0')
        self.assertEqual(accommodations[9].evaluate(), '0')
