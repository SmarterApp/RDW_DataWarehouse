...
class Test(unittest.TestCase):
    ...
    def test_generate_performance_metadata(self):
        ...
        self.assertEqual('0', meta[PerformanceMetadataConstatns.CLAIMS][PerformanceMetadataConstatns.CLAIM2][PerformanceMetadataConstatns.MAXSCORE])
        self.assertEqual('0', meta[PerformanceMetadataConstatns.CLAIMS][PerformanceMetadataConstatns.CLAIM2][PerformanceMetadataConstatns.MINSCORE])
