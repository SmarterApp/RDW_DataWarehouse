...
from smarter_score_batcher.utils.xml_utils import extract_meta_with_fallback_helper,\
    get_all_elements
from smarter_score_batcher.mapping.assessment import ItemLevelCsvColumns
...
def get_item_level_data(root):
    ...
    matrix = []
    list_of_elements = ItemLevelCsvColumns.get_item_level_csv_keys(ItemLevelCsvColumns)
    attribute_name_keys = ['key', 'segmentId', 'position', 'clientId', 'operational', 'isSelected', 'format', 'score', 'scoreStatus', 'adminDate', 'numberVisits', 'strand', 'contentLevel', 'pageNumber', 'pageVisits', 'pageTime', 'dropped']
