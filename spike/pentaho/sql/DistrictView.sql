SELECT
   dim_inst_hier.school_name AS school_name,
   dim_inst_hier.school_guid AS school_guid,
...
WHERE fact_asmt_outcome.state_code = 'NY' AND fact_asmt_outcome.district_guid in ('228', '229')
GROUP BY dim_inst_hier.school_name, dim_inst_hier.school_guid, dim_asmt.asmt_subject --, dim_asmt.asmt_custom_metadata
ORDER BY dim_inst_hier.school_name, dim_asmt.asmt_subject DESC