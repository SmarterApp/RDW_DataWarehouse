SELECT dim_student.student_guid AS student_guid, 
...
JOIN dim_student ON dim_student.student_guid = fact_asmt_outcome.student_guid
...
WHERE fact_asmt_outcome.school_guid in ('248')
AND fact_asmt_outcome.asmt_grade in ('11')
AND fact_asmt_outcome.district_guid in ('228')
