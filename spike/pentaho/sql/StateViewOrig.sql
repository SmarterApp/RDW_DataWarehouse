...
max(fact_asmt_outcome.district_guid),
dim_asmt.asmt_subject,
count(case when fact_asmt_outcome.asmt_perf_lvl=1 then fact_asmt_outcome.student_guid end) as lvl1,
count(case when fact_asmt_outcome.asmt_perf_lvl=2 then fact_asmt_outcome.student_guid end) as lvl2,
count(case when fact_asmt_outcome.asmt_perf_lvl=3 then fact_asmt_outcome.student_guid end) as lvl3,
count(case when fact_asmt_outcome.asmt_perf_lvl=4 then fact_asmt_outcome.student_guid end) as lvl4,
count(case when fact_asmt_outcome.asmt_perf_lvl=5 then fact_asmt_outcome.student_guid end) as lvl5,
