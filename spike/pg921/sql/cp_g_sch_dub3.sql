    ...
    select
     ...
     , di.account_sid as account_abbrev
         ...
         , -- count(*) over (partition by dstu.eternal_student_sid, di.school_sid)
            cast(null as char) as std_total_rows
        ...
        fao
          join dw.fact_enroll fe on fao.dim_student_key = fe.dim_student_key and fe.is_reporting_classe 
          join dw.dim_institution di on fe.dim_institution_key = di.dim_institution_key and not di.demo_flag and ( di.school_sid in ('79394925', '79394423', '79395100', '79395771', '79394101', '79394310', '79395205', '79394622', '15770391', '79395476', '79394066', '79394220', '79395057', '137672224', '79393989', '79394822', '79394491', '79394656', '79396033', '79394353', '79394891', '79395979', '15770388', '15770384', '79394856') and di.district_sid in ('15753404') and di.account_sid = '15753406'
