...
select 'Institution'     as report_comparison_type
     ...
     , 'School Group'            as is_report_level
     , 5              as is_report_level_sid
                                                   ...
                                                   and bm.year_sid = fe.year_sid
                                                              ...
                                                              join dw.dim_institution           di      on fe.dim_institution_key      = di.dim_institution_key
                                                                                                                    and not di.demo_flag
                                                                                                                      and ( di.school_sid in ('79394925', '79394423', '79395100', '79395771', '79394101', '79394310', '79395205', '79394622', '15770391', '79395476', '79394066', '79394220', '79395057', '137672224', '79393989', '79394822', '79394491', '79394656', '79396033', '79394353', '79394891', '79395979', '15770388', '15770384', '79394856', '79395882', '79394726', '15770390', '79395839', '15770386', '79394148', '79394691', '79394960', '15770387', '79394457', '15770385', '79394389', '91032670', '79394761', '79394254', '79395534', '15770389', '79396192', '79394567', '79393953')
                                                                                                                                )
                                                                                                                                                                                                                                               and di.district_sid
                                                                                                                               in ('15753404')
...
cross join (select calendar_date as as_of_date, case when calendar_date = current_date then 'Now*' else to_char(calendar_date, 'mm/dd/yyyy') end as display_date  from dw.dim_time where calendar_date in ('08/31/2011')) dates
left join
(
select dim_student_key
         , eternal_student_sid   
