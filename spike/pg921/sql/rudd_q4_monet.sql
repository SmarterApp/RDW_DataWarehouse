...
select
       CAST(di.account_sid AS varchar(10))                         as _account_code
     , di.account_name                                      as _account_name
     , CAST(di.district_sid AS varchar(10))                             as school_group_code
        ...
        select dim_student_key
          ...
          from (
                ...
                select fao.dim_student_key         as dim_student_key
                     ...
                     , CAST(academic_year_code AS integer) as academic_year_order
  ...
  join dw.dim_perf_level      dpl      on fao.dim_perf_level_key   = dpl.dim_perf_level_key
