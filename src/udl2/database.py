    ...
    'TABLES': {
        ...
        'STG_SBAC_ASMT_OUTCOME': {
            'columns': [
                ...
                ('dmg_tt1_apl', False, 'varchar(256)', '', True, 'Title I School Supplemental Services Applied Status'),
                ('dmg_tt1_elg', False, 'varchar(256)', '', True, 'Title I School Supplemental Services Eligible Status'),
                ('dmg_tt1_rcv', False, 'varchar(256)', '', True, 'Title I School Supplemental Services Received Status'),
                ('dmg_tt1_swp', False, 'varchar(256)', '', True, 'Title I Schoolwide Program Participation'),
                ('dmg_tt1_tap', False, 'varchar(256)', '', True, 'Title I Targeted Assistance Participation'),
        ...
        'INT_SBAC_ASMT_OUTCOME': {
            'columns': [
                ...
                ('dmg_tt1_apl', False, 'bool', '', True, 'Title I School Supplemental Services Applied Status'),
                ('dmg_tt1_elg', False, 'bool', '', True, 'Title I School Supplemental Services Eligible Status'),
                ('dmg_tt1_rcv', False, 'bool', '', True, 'Title I School Supplemental Services Received Status'),
                ('dmg_tt1_swp', False, 'bool', '', True, 'Title I Schoolwide Program Participation'),
                ('dmg_tt1_tap', False, 'bool', '', True, 'Title I Targeted Assistance Participation'),
