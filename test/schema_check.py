...
class EdTestSchema(TestBase):
    ...
    def _generate_mismatch_metadata(self, engine, schema):
        ...
        tbl_unicode = Table('tbl_unicode', qa_metadata, Column('id', Unicode(50), primary_key=True), schema=schema,)
        ...
        tbl_master = Table('tbl_master', qa_metadata,
                           ...
                           Column('string_long', String(50), ForeignKey(tbl_string.c.id)),
                           Column('unicode_string', Unicode(50), ForeignKey(tbl_string.c.id)),
