...
class TestUdlIntegration(ComparingPopulationsHelper, LosHelper, IndividualStudentHelper):
    ...
    def test_udl_integration_data(self):
        self.validate_state_view()
        self.validate_district_view()
        self.validate_school_view()
        self.validate_grade_view()
        self.validate_isr()
    ...
    def validate_district_view(self):
