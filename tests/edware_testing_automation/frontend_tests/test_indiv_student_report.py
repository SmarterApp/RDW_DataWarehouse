...
class IndividualStudentReport(IndividualStudentHelper, LosHelper):
    ...
    def test_grade_11_individual_student_report(self):
        ...
        content_text = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
    ...
    def test_individual_student_report_summative(self):
        ...
        math_info = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
        ...
        math_perf_bar = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
        ...
        math_score = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
        ...
        math_claim_content = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
        ...
        self.select_subject_view("ELA/Literacy")
        self.check_current_subject_view("ELA/Literacy")
        ela_info = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
        ...
        ela_score = self.driver.find_element_by_id("individualStudentContent").find_element_by_id(
                "assessmentSection1").find_element_by_class_name("overallScoreSection")
    ...
    def test_isr_switch_views(self):
        ...
        no_results_msg = str(
                self.driver.find_element_by_id("individualStudentContent").find_element_by_class_name("no_data").text)
    ...
    def test_iab_ela_only(self):
        ...
        no_results_iab_header = str(
                self.driver.find_element_by_id("individualStudentContent").find_element_by_class_name(
