...
class MultipleOpportunities(IndividualStudentHelper, LosHelper, SessionShareHelper):
    ...
    def test_multiple_opp_isr(self):
        ...
        ela_assmnt_info = self.driver.find_element_by_id("assessmentSection0").find_element_by_class_name("sidebar")
    ...
    def get_student_info(self, linkid):
        WebDriverWait(self.driver, 15).until(
                lambda driver: driver.find_element_by_class_name("ui-jqgrid-bdiv").find_element_by_id(linkid))
        return self.driver.find_element_by_class_name("ui-jqgrid-bdiv").find_element_by_id(
    ...
    def assessment_dropdown_text_isr(self):
        ...
        dropdown_text = []
        dropdown_menu = self.driver.find_element_by_class_name("asmtDropdownMenu").find_elements_by_tag_name("li")
