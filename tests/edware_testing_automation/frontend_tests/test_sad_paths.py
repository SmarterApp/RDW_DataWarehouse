...
class SadPathTests(SessionShareHelper):
    ...
    ''' Invalid parameters in the reports '''
    ...
    def test_sad_path_invalid_parameters_state(self):
        ...
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations.html?stateCode=XX")
    ...
    def test_sad_path_invalid_parameters_district(self):
        ...
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations.html?stateCode=NC&districtId=999")
        self.enter_login_credentials("cdavis", "cdavis1234")
        self.check_no_data_msg()
        # District View - Incorrect state code
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations.html?stateCode=XX&districtId=228")
        self.check_error_msg()
        # District View - Incorrect state code and district code
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations.html?stateCode=XX&districtId=999")
        self.check_error_msg()
    ...
    def test_sad_path_invalid_field_name_state(self):
        ...
        # State View - Incorrect state code
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations.html?stateId=NC")
        self.enter_login_credentials("cdavis", "cdavis1234")
        self.check_error_msg()
    ...
    def test_sad_path_invalid_report_name(self):
        ...
        self.check_error_msg()
        # LOS - schoolId and districtId invalid; other parameters valid
        self.driver.get(self.get_url() + "/assets/html/comparingPopulations000000.html?stateCode=NC&districtId=999")
        self.check_error_msg()
