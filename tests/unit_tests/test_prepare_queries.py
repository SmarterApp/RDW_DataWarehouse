...
class TestPrepareQueries(unittest.TestCase):
    ...
    def test_create_fdw_extension_query(self):
        actual_value = queries.create_fdw_extension_query('test_schema')
    ...
    def test_create_fdw_server_query(self):
        actual_value = queries.create_fdw_server_query('test_server')
    ...
    def test_create_ddl_csv_query(self):
        ...
        actual_value = queries.create_ddl_csv_query(header_names, header_types, csv_file, csv_schema, csv_table, fdw_server)
    ...
    def test_drop_ddl_csv_query(self):
        actual_value = queries.drop_ddl_csv_query('test_schema', 'test_table')
    ...
    def test_create_inserting_into_staging_query(self):
        ...
        actual_value_with_tran_rules = queries.create_inserting_into_staging_query(stg_asmt_outcome_columns, apply_rules, csv_table_columns, staging_schema,
                                                                                   staging_table, csv_schema, csv_table, transformation_rules)
        ...
        apply_rules = False
        actual_value_without_tran_rules = queries.create_inserting_into_staging_query(stg_asmt_outcome_columns, apply_rules, csv_table_columns, staging_schema,
                                                                                      staging_table, csv_schema, csv_table, transformation_rules)
    ...
    def test_set_sequence_query(self):
        staging_table = 'test_staging_table'
        start_seq = '10'
        actual_value = queries.set_sequence_query(staging_table, start_seq)
    ...
    def test_create_sequence_query(self):
        ...
        start_seq = '10'
        actual_value = queries.create_sequence_query(staging_schema, seq_name, start_seq)
    ...
    def test_drop_sequence_query(self):
        staging_schema = 'test_staging_schema'
        seq_name = 'test_seq_name'
        actual_value = queries.drop_sequence_query(staging_schema, seq_name)
    ...
    def test_apply_transformation_rules(self):
        ...
        actual_value_with_tran_rules = queries.apply_transformation_rules(apply_rules, csv_table_columns, transformation_rules)
        expected_value_with_tran_rules = ['rule1(csv_col_1)', 'rule2(csv_col_2)', 'csv_col_3']
        self.assertEqual(actual_value_with_tran_rules, expected_value_with_tran_rules)
        apply_rules = False
        actual_value_without_tran_rules = queries.apply_transformation_rules(apply_rules, csv_table_columns, transformation_rules)
