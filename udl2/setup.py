...
setup(name='udl2',
      ...
      packages=['edschema', 'edschema.metadata', 'edschema.tests', 'fileloader', 'filesplitter', 'final_cleanup', 'move_to_integration',
                'move_to_target', 'sfv', 'udl2', 'udl2_util', 'udl2_tests',
                'rule_maker', 'rule_maker.makers', 'rule_maker.rules', 'preetl'],
      ...
      data_files=[('/var/log/wgen/edware-udl/logs', ['logs/udl2.audit.log', 'logs/udl2.error.log']),
                  ...
                  ('/opt/wgen/edware-udl/zones/datafiles/henshin_out', ['tests/data/integration/METADATA_ASMT_ID_0.json',
