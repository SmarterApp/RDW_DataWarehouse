...
setup(name='udl2',
      ...
      packages=['edschema', 'edschema.metadata', 'edschema.tests', 'fileloader', 'filearrived', 'filesplitter', 'final_cleanup', 'move_to_integration',
      ...
      data_files=[('/var/log/wgen/edware-udl/logs', ['logs/udl2.audit.log', 'logs/udl2.error.log']),
                  ...
                  ('/opt/wgen/edware-udl/zones/datafiles/', ['tests/data/valid_csv.csv',
                                                             ...
                                                             'tests/data/test_missing_json_file.tar.gz.gpz',
                                                             'tests/data/test_empty_json_file.tar.gz.asc',
