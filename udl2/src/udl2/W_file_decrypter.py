...
class DecrypterTask(Udl2BaseTask):

    def run(self, incoming_msg):
        """
        ...
        # Benchmark
        benchmark = BatchTableBenchmark(guid_batch, load_type, self.name, start_time, finish_time, task_id=str(self.request.id))
