    ...
    'TABLES': {
        ...
        'STG_SBAC_ASMT_OUTCOME': {
            'columns': [
                ...
                ('created_date', False, 'timestamp', 'now()', False, "Date on which record is inserted"),
                ('acc_asl_video_embed', False, 'smallint', '', True, 'ASL Video'),
                ('acc_asl_human_nonembed', False, 'smallint', '', True, 'Human ASL Signer'),
                ('acc_braile_embed', False, 'smallint', '', True, 'Fully Brailled'),
                ('acc_closed_captioning_embed', False, 'smallint', '', True, 'Closed Captioning: ELA Listening Stimuli'),
                ('acc_text_to_speech_embed', False, 'smallint', '', True, 'Text-to-speech: ELA Reading Passages'),
                ('acc_abacus_nonembed', False, 'smallint', '', True, 'Abacus'),
                ('acc_alternate_response_options_nonembed', False, 'smallint', '', True, 'Alternative Response Options'),
                ('acc_calculator_nonembed', False, 'smallint', '', True, 'Calculator'),
                ('acc_multiplication_table_nonembed', False, 'smallint', '', True, 'Multiplication Table'),
                ('acc_print_on_demand_nonembed', False, 'smallint', '', True, 'Printed stimuli/Items'),
                ('acc_read_aloud_nonembed', False, 'smallint', '', True, 'Read-aloud: ELA Reading Passages'),
                ('acc_scribe_nonembed', False, 'smallint', '', True, 'Scribe: ELA Writing Items'),
                ('acc_speech_to_text_nonembed', False, 'smallint', '', True, 'Speech-to-text: ELA Writing Items'),
                ('acc_streamline_mode', False, 'smallint', '', True, ''),
            ],
            'indexes': [],
            'keys': {}
        },
