...
ref_table_conf = {
    ...
    'column_mappings': [
        ...
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'nextval(\'"GLOBAL_REC_SEQ"\')', 'dim_asmt', 'asmt_rec_id', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'guid_asmt', 'dim_asmt', 'asmt_guid', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'type', 'dim_asmt', 'asmt_type', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'period', 'dim_asmt', 'asmt_period', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'year', 'dim_asmt', 'asmt_period_year', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'version', 'dim_asmt', 'asmt_version', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'subject', 'dim_asmt', 'asmt_subject', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_claim_1', 'dim_asmt', 'asmt_claim_1_name', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_claim_2', 'dim_asmt', 'asmt_claim_2_name', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_claim_3', 'dim_asmt', 'asmt_claim_3_name', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_claim_4', 'dim_asmt', 'asmt_claim_4_name', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_perf_lvl_1', 'dim_asmt', 'asmt_perf_lvl_name_1', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_perf_lvl_2', 'dim_asmt', 'asmt_perf_lvl_name_2', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_perf_lvl_3', 'dim_asmt', 'asmt_perf_lvl_name_3', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_perf_lvl_4', 'dim_asmt', 'asmt_perf_lvl_name_4', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'name_perf_lvl_5', 'dim_asmt', 'asmt_perf_lvl_name_5', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_overall_min', 'dim_asmt', 'asmt_score_min', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_overall_max', 'dim_asmt', 'asmt_score_max', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_1_min', 'dim_asmt', 'asmt_claim_1_score_min', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_1_max', 'dim_asmt', 'asmt_claim_1_score_max', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_1_weight', 'dim_asmt', 'asmt_claim_1_score_weight', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_2_min', 'dim_asmt', 'asmt_claim_2_score_min', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_2_max', 'dim_asmt', 'asmt_claim_2_score_max', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_2_weight', 'dim_asmt', 'asmt_claim_2_score_weight', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_3_min', 'dim_asmt', 'asmt_claim_3_score_min', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_3_max', 'dim_asmt', 'asmt_claim_3_score_max', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_3_weight', 'dim_asmt', 'asmt_claim_3_score_weight', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_4_min', 'dim_asmt', 'asmt_claim_4_score_min', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_4_max', 'dim_asmt', 'asmt_claim_4_score_max', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_claim_4_weight', 'dim_asmt', 'asmt_claim_4_score_weight', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_cut_point_1', 'dim_asmt', 'asmt_cut_point_1', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_cut_point_2', 'dim_asmt', 'asmt_cut_point_2', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_cut_point_3', 'dim_asmt', 'asmt_cut_point_3', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'score_cut_point_4', 'dim_asmt', 'asmt_cut_point_4', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'NULL', 'dim_asmt', 'asmt_custom_metadata', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', "TO_CHAR(CURRENT_TIMESTAMP, 'yyyymmdd')", 'dim_asmt', 'from_date', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', "99991231'", 'dim_asmt', 'to_date', None, None),
        ('4', 'INT_SBAC_ASMT_OUTCOME', 'TRUE', 'dim_asmt', 'most_recent', None, None),
        ...
        ('4', 'INT_SBAC_ASMT_OUTCOME', "CURRENT_TIMESTAMP", 'fact_asmt_outcome', 'record_create_datetime', None, None),
