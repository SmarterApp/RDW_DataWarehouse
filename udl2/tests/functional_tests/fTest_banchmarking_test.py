...
METADATA_FILE_PATTERN = '/opt/wgen/edware-udl/zones/datafiles/Banchmarking_json_file.json'
FACT_OUTCOME_FILE_PATTERN = '/opt/wgen/edware-udl/zones/datafiles/BANCHMARK_DATA.csv'
