...
'''
import unittest
from move_to_integration.move_to_integration import create_migration_query
import re
...
class TestLoadToIntegrationTable(unittest.TestCase):
    def test_create_migration_query(self,):
        ...
        target_columns = ['batch_id', 'substr_test', 'number_test']
        source_columns_with_tran_rule = ['A.batch_id', 'SUBSTR(A.substr_test, 1, 10)', 'TO_NUMBER(A.number_test, \'99999\')']
