...
def test_create_assessment_object():
    asmt = generate_data.create_assessment_object('SUMMATIVE', 'Spring', 2015, 'ELA')
...
def test_create_assessment_object_interim_fall():
    asmt = generate_data.create_assessment_object('INTERIM COMPREHENSIVE', 'Fall', 2015, 'ELA')
    assert asmt.period_year == 2015
...
def test_create_assessment_object_interim_winter():
    asmt = generate_data.create_assessment_object('INTERIM COMPREHENSIVE', 'Winter', 2015, 'ELA')
    assert asmt.period_year == 2015
...
def test_create_assessment_object_interim_spring():
    asmt = generate_data.create_assessment_object('INTERIM COMPREHENSIVE', 'Spring', 2015, 'ELA')
    assert asmt.period_year == 2015
    assert asmt.period == 'Spring 2015'
...
def test_create_assessment_outcome_object_skipped():
    ...
    inst_hier = hier_gen.generate_institution_hierarchy(state, district, school)

    # Create outcomes
    outcomes = generate_data.create_assessment_outcome_object(student, asmt, section, inst_hier, skip_rate=1,
...
def test_create_assessment_outcome_object_one_active_result():
    ...
    # Create outcomes
    outcomes = generate_data.create_assessment_outcome_object(student, asmt, section, inst_hier, skip_rate=0,
                                                              retake_rate=0, delete_rate=0, update_rate=0)
...
def test_create_assessment_outcome_objects_no_interims_skipped():
    # Create objects
    asmt_summ = asmt_gen.generate_assessment('SUMMATIVE', 'Spring', 2015, 'ELA')
    state = hier_gen.generate_state('devel', 'Example State', 'ES')
    district = hier_gen.generate_district('Small Average', state)
    school = hier_gen.generate_school('Elementary School', district)
    clss = enroll_gen.generate_class('Class', 'ELA', school)
    ...
    # Create outcomes
    outcomes = generate_data.create_assessment_outcome_objects(student, asmt_summ, [], section, inst_hier, skip_rate=1,
                                                               retake_rate=0, delete_rate=0, update_rate=0)
...
def test_create_assessment_outcome_objects_no_interims_one_active_result():
    ...
    # Create outcomes
    outcomes = generate_data.create_assessment_outcome_objects(student, asmt_summ, [], section, inst_hier, skip_rate=0,
                                                               retake_rate=0, delete_rate=0, update_rate=0)
...
def test_create_assessment_outcome_objects_interims_skipped():
    # Create objects
    asmt_summ = asmt_gen.generate_assessment('SUMMATIVE', 'Spring', 2015, 'ELA')
    interim_asmts = [asmt_gen.generate_assessment('INTERIM COMPREHENSIVE', 'Fall', 2015, 'ELA'),
                     asmt_gen.generate_assessment('INTERIM COMPREHENSIVE', 'Winter', 2015, 'ELA'),
                     asmt_gen.generate_assessment('INTERIM COMPREHENSIVE', 'Spring', 2015, 'ELA')]
    state = hier_gen.generate_state('devel', 'Example State', 'ES')
    district = hier_gen.generate_district('Small Average', state)
    school = hier_gen.generate_school('Elementary School', district)
    clss = enroll_gen.generate_class('Class', 'ELA', school)
